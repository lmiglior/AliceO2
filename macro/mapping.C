...
void mapping()
{
  ...
  const std::string inputGeom = "/localhome/mft/alice/o2sim_geometry.root";
  ...
  fstream output_draw1;
  fstream output_draw2;
  fstream output_canvas;
  output_mapping.open("/localhome/mft/alice/output_raw/mapping.txt",ios::out);
  output_histoname.open("/localhome/mft/alice/output_raw/histoname.txt",ios::out);
  output_canvas.open("/localhome/mft/alice/output_raw/canvas.txt",ios::out);
